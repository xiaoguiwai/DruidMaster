...
{
    [CombatRoutineMetaData(Class.Druid, Specialization.DruidRestoration, "Iker", "V2.0", "DruidMaster",
         "DruidMaster")]
    public class DruidMaster : CombatRoutine
    {
        ...
        public override async Task<bool> CombatAsync()
        {
            ...
            UseAbilities(targetmanager.Solution_InstSpell());
            UseAbilities(targetmanager.Solution_General());
        ...
        protected override void SetUpAbilities()
        {
            WowAbility Rejuvenation = new WowAbility(Restoration.Rejuvenation, 0, () => (Game.Instance.IsInGame && targetmanager.Rejuvenation_use_check),
                () => Restoration.Rejuvenation.IsUsable, targetmanager.RejuvenationTarget)
            {
            ...
            WowAbility HealingTouch = new WowAbility(Restoration.HealingTouch, 0, () => (Game.Instance.IsInGame && !Me.IsMoving && targetmanager.Healingtouch_use_check),
                () => Restoration.HealingTouch.IsUsable, targetmanager.HealingtouchTarget)
            {
                FacingRequired = false,
                IsTerrainClick = false,
                CancelCast = false,
            ...
            WowAbility Regrowth = new WowAbility(Restoration.Regrowth, 0, () => (Game.Instance.IsInGame && !Me.IsMoving && targetmanager.Regrowth_use_check),
                () => Restoration.Regrowth.IsUsable, targetmanager.RegrowthTarget)
            {
                FacingRequired = false,
                IsTerrainClick = false,
                CancelCast = false,
            ...
            WowAbility Lifebloom = new WowAbility(Restoration.Lifebloom, 0, () => (Game.Instance.IsInGame && targetmanager.Lifebloom_use_check),
                () => Restoration.Lifebloom.IsUsable, targetmanager.LifebloomTarget)
            {
                FacingRequired = false,
                IsTerrainClick = false,
                CancelCast = false,
            ...
            WowAbility Wildgrowth = new WowAbility(Restoration.WildGrowth, 0, () => (Game.Instance.IsInGame && !Me.IsMoving && targetmanager.WildGrouth_use_check),
                () => Restoration.WildGrowth.IsUsable, targetmanager.WildgrowthTarget)
            {
                FacingRequired = false,
                IsTerrainClick = false,
                CancelCast = false,
            ...
            WowAbility Swiftmend = new WowAbility(Restoration.Swiftmend, 0, () => (Game.Instance.IsInGame && targetmanager.SwiftMent_use_check),
               () => Restoration.Swiftmend.IsUsable, targetmanager.SwiftmendTarget)
            {
                FacingRequired = false,
                IsTerrainClick = false,
                CancelCast = false,
            ...
            WowAbility Barkskin = new WowAbility(Restoration.Barkskin, 0, () => (Game.Instance.IsInGame && targetmanager.BarkSkin_use_check),
               () => Restoration.Barkskin.IsUsable, targetmanager.BarkskinTarget)
            {
                FacingRequired = false,
                IsTerrainClick = false,
                CancelCast = false,
            ...
            WowAbility IronBark = new WowAbility(Restoration.Ironbark, 0, () => (Game.Instance.IsInGame && targetmanager.IronBark_use_check),
               () => Restoration.Ironbark.IsUsable, targetmanager.IronbarkTarget)
            {
                FacingRequired = false,
                IsTerrainClick = false,
                CancelCast = false,
            ...
            WowAbility EssenceofGHanirArtifact = new WowAbility(General.EssenceofGHanirArtifact, 0, () => (Game.Instance.IsInGame && targetmanager.EssenceofGHanirArtifact_use_check),
               () => General.EssenceofGHanirArtifact.IsUsable, targetmanager.EssenceofGHanirArtifactTarget)
            {
                FacingRequired = false,
                IsTerrainClick = false,
                CancelCast = false,
            ...
            WowAbility Innervate = new WowAbility(Restoration.Innervate, 0, () => (Game.Instance.IsInGame && targetmanager.Innervate_use_check),
               () => Restoration.Innervate.IsUsable, targetmanager.InnervateTarget)
            {
                FacingRequired = false,
                IsTerrainClick = false,
                CancelCast = false,
            ...
            targetmanager.GeneralSpellList.Add(Swiftmend);
            targetmanager.GeneralSpellList.Add(EssenceofGHanirArtifact);
            targetmanager.GeneralSpellList.Add(Wildgrowth);
            targetmanager.GeneralSpellList.Add(Lifebloom);
            targetmanager.GeneralSpellList.Add(Rejuvenation);
            targetmanager.GeneralSpellList.Add(HealingTouch);
            targetmanager.GeneralSpellList.Add(Regrowth);


            //Control_and_Protec Spell list
            targetmanager.InstantSpellList.Add(Barkskin);
            targetmanager.InstantSpellList.Add(IronBark);
            targetmanager.InstantSpellList.Add(Innervate);
